...
class Physician extends Component {
  ...
  onAskQuestions = () => {
    axios
      .get(`${ASK_QUETIONS_URL}${this.state.currentQuestion}`, {
        headers: {
          "Content-Type": "application/json",
        },
      })
  ...
  onClickPrediction = () => {
    ...
    var data = [
      [
        ...
        this.state.smokingHistory,
        this.state.bmi,
        this.state.hbA1cLevel,
        this.state.bloodGlucoseLevel,
      ],
    ];
        ...
        <Tabs defaultActiveKey="prediction">
          <Tabs.TabPane tab="Prediction" key="prediction">
            ...
            <p style={{ fontWeight: "normal", fontSize: "15px" }}>
              Please input the following information to get a prediction of your
            ...
            <Form ref={this.formRef}>
              ...
              <Form.Item
                ...
                initialValue={6.6}
                rules={[
                  { required: true, message: "Please input valid numbers" },
                ]}
                labelAlign="left"
                wrapperCol={{ span: 19 }}
              >
          ...
          <Tabs.TabPane tab="Chatbot" key="chatbot">
            <p className="larger-text">IntelliHealth Prediction</p>
            <p style={{ fontWeight: "normal", fontSize: "15px" }}>
              If you have any question, feel free to ask any questions about the
              diabetes
            </p>
